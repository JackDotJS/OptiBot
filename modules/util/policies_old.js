...
module.exports = (bot) => {
    return [
        ...
        },
        {
            ...
            .addField('Follow the rules (duh)', `Becoming a moderator does not mean you are above the law and magically exempt from the rules. Set a good example for other members and follow the rules at all times.`)
            .addField('Remain unbiased', `Becoming a moderator does not mean you are above the law and magically exempt from the rules. Set a good example for other members and follow the rules at all times.`)
        ...
        {
            type: 2,
            kw: ['rule 1', 'no spamming', 'spam', 'spamming', 'mass ping', 'wall of text'],
            embed: new djs.MessageEmbed()
            .setColor(bot.cfg.embed.default)
        ...
        {
            type: 2,
            kw: ['rule 2', 'no advertising', 'ads', 'advertising', 'invite links'],
            embed: new djs.MessageEmbed()
            .setColor(bot.cfg.embed.default)
            .setTitle('Rule #2 | No Advertising')
        ...
        },
        {
            ...
            embed: new djs.MessageEmbed()
            .setColor(bot.cfg.embed.default)
            .setTitle('Rule #3 | No Prohibited Content')
            .setDescription(`As stated in the <#479192475727167488>, The following content is NOT allowed at any time:\n●  Bigotry, Nazism, and other offensive content.\n●  Pornographic, questionable, and other NSFW content.\n●  Disturbing or shocking NSFL content.\n●  Confidential and personal information\n●  Politics, religion, and other controversial issues.\n●  Cracks and pirated content in general.\n●  Flashing animated pictures.\n\nThese restrictions apply to EVERYTHING. Discussions, images, links, profile pictures, nicknames, etc.`)
            .addField('Policy', `Offending content should be deleted immediately. Users who join the server solely to post this kind of content are to be banned. All others are up to your discretion as a moderator.`)
        },
        {
            type: 2,
            kw: ['rule 4', 'keep discussions friendly, respectful, and (above all) civil', 'friendly', 'respectful', 'civil', 'toxicity', 'insults', 'defamation', 'slander', 'harassment', 'degradation', 'slurs', 'racial slurs', 'racism', 'nword', 'flaming', 'flame war', 'hate speech', 'homophobia', 'transphobia'],
            embed: new djs.MessageEmbed()
            .setColor(bot.cfg.embed.default)
            .setTitle('Rule #4 | Keep discussions friendly, respectful, and (above all) civil')
            .setDescription(`The internet is, unfortunately, quite a toxic place when you really look at it. Masked with anonymity, we tend to show our true colors. As moderators, we must attempt to combat this norm and try to create a clean, friendly environment for our members. This especially goes for our new members. As much as we hate having to deal with the new guy, remember that us too were all there at one point, starting from the bottom. All our members should aim to be patient and supportive of each other.\nThe following is not allowed:\n\n●  Insults\n●  Defamation/Slander\n●  Harassment\n●  Degradation\n●  Racial slurs (including "soft n-words")\n●  Flaming/Flame wars\n●  Hate speech\n●  Homophobia, Transphobia, etc`)
        ...
        {
            type: 2,
            kw: ['rule 5', 'keep topics to their appropriate channels', 'offtopic', 'inappropriate channel', 'wrong channel', 'wrong topic', 'move discussion'],
            embed: new djs.MessageEmbed()
            .setColor(bot.cfg.embed.default)
            .setTitle('Rule #5 | Keep topics to their appropriate channels')
        ...
        {
            type: 2,
            kw: ['rule 6', 'discord terms of service & community guidelines', 'tos', 'community guidelines', 'discord', 'discord rules', 'trust and safety'],
            embed: new djs.MessageEmbed()
            .setColor(bot.cfg.embed.default)
            .setTitle('Rule #6 | Discord Terms of Service & Community Guidelines')
            .setDescription(`**THIS IS IMPORTANT.** Discord's own rules are to be strictly enforced AT ALL TIMES. Failure to do so may result in deletion of our server and bans on our accounts.\n\nYou can read these rules here:\n●  [Discord Terms of Service](https://discordapp.com/terms)\n●  [Discord Community Guidelines](https://discordapp.com/guidelines)\n\nMany of our own server rules mimic Discord's rules already, so there's not a whole lot to go over. In summary, the following is strictly forbidden:\n●  Users under the age of 13 years old.\n●  Any form of illegal content.\n●  Organization of community raids and other forms of harassment.\n●  Distribution of viruses and malware.\n●  Distribution of exploits or cheats for games.`)
        ...
        {
            type: 2,
            kw: ['rule 7', 'do not beg for capes', 'begging', 'free cape', 'asking for cape', 'capes'],
            embed: new djs.MessageEmbed()
            .setColor(bot.cfg.embed.default)
            .setTitle('Rule #7 | Do not beg for capes')
            .setDescription(`Capes are supposed to be a gift given to users who donate $10 to OptiFine's development. As such, not only is begging for a cape just plain pathetic, but also somewhat disrespectful to the developer.`)
        ...
        },
        {
            ...
            .addField('Policy', `OptiBot commands are not *strictly* limited to <#626843115650547743>, but generally any bot usage that is not relevant to any active conversation should be kept to this channel. Members who fail to do so may be in violation of rules #1 and/or #5.`)
        },
        {
            type: 2,
            ...
            .addField('Policy', `To keep everything clean and organized, memes are to be kept to the <#584850909725458503> channel at ALL times. This type of content is not allowed in any other channel, not even <#426005631997181963>. Reactions images are allowed as long as they’re used in the context of a reaction, and not being posted repetitively. Members who fail to follow these conditions are in violation of rules #1 and/or #5.`)
        },
        {
            type: 0,
