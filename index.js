            ...
            if (err || !res || !body) {
                ...
                function loop1() {
                    ...
                    */
                    ...
                    // i once had the idea to display the ratings and other data when a url is detected, but now i wanna keep it simple

                    let tld = thisLine[0].trim().replace(/\s/g, ".");

                    if (tld.match(/^-+$/) === null && tld.length !== 0) {
                        smr_data.push(tld);
                    }
