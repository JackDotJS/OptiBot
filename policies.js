...
[
    ...
    },
    {
        ...
        .setDescription(`A <@&644668061818945557> has the same job as Moderators, only with restricted moderation abilities. During their evaluation period, Jr. Moderators are NOT able to kick/ban server members or directly delete messages, but they have access to MOST bot-based moderation commands, including \`${bot.prefix}mute\` and \`${bot.prefix}warn\``)
    },
    {
        type: 1,
        embed: new djs.MessageEmbed()
